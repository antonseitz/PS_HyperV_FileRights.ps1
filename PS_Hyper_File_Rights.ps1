...
# "Zuordnungen von Kontennamen und Sicherheitskennungen wurden nicht durchgefÃ¼hrt."
# Diese SID steht fÃ¼r den Hyper SCSI Bus und ist global, d.h. bei allen VMs gleich.
